...
export function MessageThreadModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="message-thread-title">
      <div className="relative w-full max-w-2xl mx-4 max-h-[80vh] bg-surface-1 border border-border-default rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        {/* Header */}
            ...
            <>
              ...
              {parentMessage && (
                <div className="p-4 bg-accent/5 border border-accent/20 rounded-xl space-y-3">
                  ...
                  <p className="text-sm text-muted-1">{parentMessage.content}</p>
                  <button
              ...
              {replies.length > 0 ? (
                <div className="space-y-3">
                  {replies.map((reply) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-1 pl-8">{reply.content}</p>
                      <button
                ...
                <div className="text-center py-8">
                  <p className="text-muted-3 text-sm">No replies yet. Be the first!</p>
                </div>
              )}
        ...
        >
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-accent hover:bg-accent text-black rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 font-bold"
            >
              {sending ? (
