...
const creationTypeIcons: Record<string, ReactNode> = {
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="border-b border-zinc-900">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            <Link href="/" className="text-cyan-400 font-medium">Browse</Link>
            <Link href="/" className="text-zinc-500 hover:text-white transition">Home</Link>
          </nav>
        </div>
      </header>
      ...
      <footer className="border-t border-zinc-900 mt-20">
        <div className="max-w-7xl mx-auto px-6 py-10 flex items-center justify-between">
          ...
          <Link href="/" className="text-zinc-600 hover:text-white transition text-sm">
            Home
          </Link>
        </div>
      </footer>
