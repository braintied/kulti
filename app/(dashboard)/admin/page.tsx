    ...
    <div className="space-y-8">
      ...
      <div className="rounded-lg border border-border-default bg-surface-1">
        ...
        <div className="divide-y divide-border-default">
          {loading ? (
            <div className="p-8 text-center text-muted-3" role="status">
            ...
            activity.map((item) => (
              <div key={item.id} className="p-4 hover:bg-surface-2/30">
                <p className="text-sm text-white">{item.message}</p>
                <p className="mt-1 text-xs text-muted-3">{item.timestamp}</p>
              </div>
            ))
          )}
        </div>
      ...
      <div className="rounded-lg border border-border-default bg-surface-1 p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <a
            href="/admin/users"
            className="rounded-lg border border-border-default p-4 text-center transition-colors hover:border-purple-500 hover:bg-surface-2 min-h-[120px] flex flex-col items-center justify-center"
